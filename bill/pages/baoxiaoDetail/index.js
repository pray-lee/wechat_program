...
Page({
                ...
                if (res.statusCode === 200) {
                    if(res.data && res.data.length) {
                        wx.setStorage({
                            ...
                            success: res => {
                                wx.navigateTo({
                                    url: "/bill/pages/invoiceAccountbookList/index"
                                })
                            }
                        })
                    }else{
    ...
    invoiceSelect() {
        wx.navigateTo({
            url: '/bill/pages/invoiceListSelect/index?accountbookId=' + this.data.baoxiaoDetail.accountbookId
        })
    },
    /**
     *
                        ...
                        if(result) {
                            wx.setStorage({
                                ...
                                success: () => {
                                    ...
                                    wx.navigateTo({
                                        url: '/bill/pages/invoiceSelect/index?invoiceAccountbookId=' + accountbookId
                                    })
                                }
                            })
                        }
